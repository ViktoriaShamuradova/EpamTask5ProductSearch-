...
public class FindOvenCommand implements Command {
    @Override
    public List<Appliance> execute(Criteria criteria, List<Appliance> appliances) {
        ...
        List<Appliance> ovensList = new ArrayList<>();
        ...
        for (Appliance appliance : appliances) {
            if (appliance.getClass().getSimpleName().equalsIgnoreCase(searchName)) {
                ...
                if (appliance instanceof Oven) {
                    ...
                    Map<String, Object> characteristics = oven.getCharacteristics();
