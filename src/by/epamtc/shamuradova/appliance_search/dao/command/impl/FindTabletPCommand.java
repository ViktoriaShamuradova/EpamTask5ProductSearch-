...
public class FindTabletPCommand implements Command {
    @Override
    public List<Appliance> execute(Criteria criteria, List<Appliance> appliances) {
        ...
        List<Appliance> tabletPCList = new ArrayList<>();
        ...
        for (Appliance appliance : appliances) {
            if (appliance.getClass().getSimpleName().equalsIgnoreCase(searchName)) {
                ...
                if (appliance instanceof TabletPC) {
                    ...
                    Map<String, Object> characteristics = tabletPC.getCharacteristics();
